...
def analyze_logs(params):
    ...
    with open('config/workflow_activities_model.json') as f: 
    ...
    for function_name in functions:
        ...
        activity = next(act for act in WORKFLOW_INFO['activities'] if act['name'] == function_name)
        ...
        for request_id, logs in logs_by_request.items():
            ...
            service_execution = parse_logs(request_id, logs, default_statistics, activity_statistics, default_sep)
