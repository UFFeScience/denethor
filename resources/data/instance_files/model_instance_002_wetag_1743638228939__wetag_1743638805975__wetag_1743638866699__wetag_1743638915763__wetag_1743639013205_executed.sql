...
-----------'wetag_1743638228939','wetag_1743638805975','wetag_1743638866699','wetag_1743638915763','wetag_1743639013205'
-----------Generated at 2025-04-02 22:46:28
...
SELECT 
	(SELECT count(distinct st.task_id) AS _tasks_count
		...
		WHERE we.execution_tag in ('wetag_1743638228939','wetag_1743638805975','wetag_1743638866699','wetag_1743638915763','wetag_1743639013205')
	),
...
produced_file AS (
	...
	JOIN workflow_execution we ON se.we_id = we.we_id
	WHERE ef.transfer_type = 'produced' AND we.execution_tag in ('wetag_1743638228939','wetag_1743638805975','wetag_1743638866699','wetag_1743638915763','wetag_1743639013205')
	GROUP BY ef.file_id
),
consumed_files AS (
	SELECT
	...
	JOIN service_execution se ON se.se_id = ef.se_id
	JOIN workflow_execution we ON se.we_id = we.we_id
	WHERE ef.transfer_type = 'consumed' AND we.execution_tag in ('wetag_1743638228939','wetag_1743638805975','wetag_1743638866699','wetag_1743638915763','wetag_1743639013205')
	GROUP BY ef.file_id
)
SELECT 
...
-----------'wetag_1743638228939','wetag_1743638805975','wetag_1743638866699','wetag_1743638915763','wetag_1743639013205'
-----------Generated at 2025-04-02 22:46:29

#<vm1_cost> <vm2_cost> <vm3_cost>
SELECT 
    0.000005167	 AS vm1_cost,
    0.000010333  AS vm2_cost,
...
task_time AS (
	...
	JOIN vw_service_execution_task st ON se.se_id = st.se_id
	JOIN vw_task ta ON st.task_id = ta.task_id
	WHERE we.execution_tag in ('wetag_1743638228939','wetag_1743638805975','wetag_1743638866699','wetag_1743638915763','wetag_1743639013205', 'wetag_1743638228939','wetag_1743638805975','wetag_1743638866699','wetag_1743638915763','wetag_1743639013205')
	GROUP BY ta.task_id,
			 ta.activity_id,
			 se.provider_conf_id
	ORDER BY ta.task_id,
