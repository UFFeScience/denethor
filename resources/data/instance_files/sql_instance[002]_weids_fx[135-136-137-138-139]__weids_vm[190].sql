...
--->weids_fx:[135, 136, 137, 138, 139]
--->weids_vm:[190]
--->Generated at 2025-04-22 20:53:20
...
SELECT 
	(SELECT count(distinct st.task_id) AS _tasks_count
		...
		WHERE we.we_id in (135,136,137,138,139)
	),
...
--->weids_fx:[135, 136, 137, 138, 139]
--->weids_vm:[190]
--->Generated at 2025-04-22 20:53:27
...
produced_file AS (
	...
	JOIN workflow_execution we ON se.we_id = we.we_id
	WHERE ef.transfer_type = 'produced' AND we.we_id in (135,136,137,138,139)
	GROUP BY ef.file_id
),
consumed_files AS (
	SELECT
	...
	JOIN service_execution se ON se.se_id = ef.se_id
	JOIN workflow_execution we ON se.we_id = we.we_id
	WHERE ef.transfer_type = 'consumed' AND we.we_id in (135,136,137,138,139)
	GROUP BY ef.file_id
)
SELECT 
...
--->weids_fx:[135, 136, 137, 138, 139]
--->weids_vm:[190]
--->Generated at 2025-04-22 20:53:30
...
--->weids_fx:[135, 136, 137, 138, 139]
--->weids_vm:[190]
--->Generated at 2025-04-22 20:53:31
