...
-----------'wetag_1743678423945','wetag_1743678525527','wetag_1743678605279','wetag_1743678680757','wetag_1743678753528'
-----------Generated at 2025-04-03 08:55:30
...
SELECT 
	(SELECT count(distinct st.task_id) AS _tasks_count
		...
		WHERE we.execution_tag in ('wetag_1743678423945','wetag_1743678525527','wetag_1743678605279','wetag_1743678680757','wetag_1743678753528')
	),
...
produced_file AS (
	...
	JOIN workflow_execution we ON se.we_id = we.we_id
	WHERE ef.transfer_type = 'produced' AND we.execution_tag in ('wetag_1743678423945','wetag_1743678525527','wetag_1743678605279','wetag_1743678680757','wetag_1743678753528')
	GROUP BY ef.file_id
),
consumed_files AS (
	SELECT
	...
	JOIN service_execution se ON se.se_id = ef.se_id
	JOIN workflow_execution we ON se.we_id = we.we_id
	WHERE ef.transfer_type = 'consumed' AND we.execution_tag in ('wetag_1743678423945','wetag_1743678525527','wetag_1743678605279','wetag_1743678680757','wetag_1743678753528')
	GROUP BY ef.file_id
)
SELECT 
...
-----------'wetag_1743678423945','wetag_1743678525527','wetag_1743678605279','wetag_1743678680757','wetag_1743678753528'
-----------Generated at 2025-04-03 08:55:31
...
-----------'wetag_1743678423945','wetag_1743678525527','wetag_1743678605279','wetag_1743678680757','wetag_1743678753528'
-----------Generated at 2025-04-03 08:55:35
...
task_time AS (
	...
	JOIN vw_service_execution_task st ON se.se_id = st.se_id
	JOIN vw_task ta ON st.task_id = ta.task_id
	WHERE we.execution_tag in ('wetag_1743678423945','wetag_1743678525527','wetag_1743678605279','wetag_1743678680757','wetag_1743678753528', 'wetag_1743678423945','wetag_1743678525527','wetag_1743678605279','wetag_1743678680757','wetag_1743678753528')
	GROUP BY ta.task_id,
			 ta.activity_id,
			 se.provider_conf_id
	ORDER BY ta.task_id,
