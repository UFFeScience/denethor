...
def lambda_handler(event, context):
    ...
    for tree_file_name in os.listdir(dir_trees):
        ...
        upload_file_to_S3(tree_file_path, BUCKET_OUTPUT, s3_output_key, s3)
        ...
        print(f"FILE_UPLOAD RequestId: {request_id}\t FileName: {tree_file_name}\t Bucket: {BUCKET_OUTPUT}\t FilePath: {s3_output_key}\t Duration: {upload_time_ms} ms\t FileSize: {file_size} bytes")
