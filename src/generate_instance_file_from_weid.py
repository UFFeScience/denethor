...
# run1 | n_inputs (first n): 2,5,10,15,20,25,30,35,40,45,50
...
# run2 | n_inputs (random): 2,5,10,15,20,25,30,35,40,45,50
...
# run3 | n_inputs (random): 2,5,10,15,20,25,30,35,40,45,50
...
# run4 | n_inputs (random): 60,70,80,90,100
# INPUT_WEIDS_FX = [269,270,271,272,273,274,275,276,280,281,282,283,284,285,286,287,288,289,290,291,292,293,294,295,296,297]
# INPUT_WEIDS_VM = []
...
def main():
    ...
    print("Starting instance file generation..." + datetime.now().strftime("%Y-%m-%d %H:%M:%S"))
    ...
    for provided_input_count, entry in weid_provider_dict.items():
        ...
        print(f"Model file {out_file_name} generated successfully.")
